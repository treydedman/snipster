...
export default function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-50 bg-mutedCyan dark:bg-zinc-900 backdrop-blur-md border-b border-zinc-200 dark:border-zinc-800">
      <nav className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <Link
            href="/"
            className="text-cyan hover:text-lightCyan dark:text-darkCyan dark:hover:text-cyan"
          >
            Home
          </Link>
